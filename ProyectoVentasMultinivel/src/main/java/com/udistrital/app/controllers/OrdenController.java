...
public class OrdenController {
	...
	public ResponseEntity<Orden> saveNuevaOrden(@RequestBody OrdenSaveDto o) {
		...
		Orden orden = new Orden(ordenId, inventario.get(), cliente.get(), periodo.get(), convertLocalDate(o.getFechaRegistro()),
	...
	public int someUpdate(OrdenSaveDto o) {
		...
		return jdbcTemplate.update(sql, o.getIdOrden(), o.getIdProducto(), o.getIdRegion(), o.getIdPeriodo(),
				convertLocalDate(o.getFechaRegistro()), o.getEstado(), o.getTipoId(), o.getNumeroId(), o.getTipoIdClienteCal(),
...
*//*
	@PutMapping("/calificacion/{calificacion}")
	public ResponseEntity<Optional<Orden>> setCalificacion(@PathVariable Boolean calificacion, @RequestBody OrdenId id) {
