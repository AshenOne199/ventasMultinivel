...
public interface CategoriaRepository extends JpaRepository<Categoria, Short>{
	...
	@Query("SELECT DISTINCT new com.udistrital.app.entity.dto.CategoriaDto(C.nombre) "
	...
	@Query("SELECT DISTINCT new com.udistrital.app.entity.dto.SubCategoriaDto(C.nombre) "
